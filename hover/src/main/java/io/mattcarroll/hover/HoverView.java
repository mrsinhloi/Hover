...
public class HoverView extends RelativeLayout {
    ...
    final HoverViewStateExpanded mExpanded = new HoverViewStateExpanded();
    ...
    HoverMenu.Section sectionSelected;
    public void setmSelectedSection(HoverMenu.Section section) {
        this.mSelectedSectionId = section.getId();
        this.sectionSelected = section;
        mExpanded.selectSection(section);
    }

    public HoverMenu.SectionId getmSelectedSectionId() {
