...
public abstract class HoverMenu {
    ...
    public static class SectionId {
        ...
        public SectionId(@NonNull String id, @NonNull int spaceTabview) {
            mId = id;
            this.spaceTabview = spaceTabview;
        }
    ...
    private static class MenuDiffCallback extends DiffUtil.Callback {
        ...
        public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
            ...
            return oldSection.getId().equals(newSection.getId())
