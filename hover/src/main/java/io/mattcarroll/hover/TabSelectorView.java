...
public class TabSelectorView extends View {
    ...
    private static final int DEFAULT_SELECTOR_WIDTH_DP = 18;//24
    private static final int DEFAULT_SELECTOR_HEIGHT_DP = 12;//16
    ...
    private void init() {
        ...
        mSelectorPaint.setColor(getResources().getColor(R.color.hover_navigator_color_white));
